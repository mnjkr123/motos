                ...
                <div>
                    <nav id="navbar" className="navbar navbar-expand-lg nav-light fixed-top sticky">
                        <div className="container">
                            ...
                            <Collapse className="navbar-collapse" isOpen={this.state.toggle} id="navbarSupportedContent">
                    ...
                    {/* Back to top */}
                    <Link to="home" style={{ display: this.arrow === true ? 'block' : 'none' }} id="back-to-top" className="back-to-top rounded-pill fs-5"><Icon.ArrowUp className="fea icon-sm icons align-middle" /></Link>
                    {/* Back to top  */}
                </div>
                {/* popup video */}
                <ModalVideo
