        ...
        return (
            <React.Fragment>
                <div>
                                ...
                                <Col>
                                    <div className="title-heading">
                                        ...
                                        <div className="mt-4 pt-2">
                                            ...
                                            <Link2 to="#" data-type="youtube" data-id="yba7hPeTSjk" onClick={this.openModal} className="btn btn-icon btn-pills btn-primary m-1 lightbox"><Icon.Video className="icons" /></Link2><span className="text-uppercase text-white-50 small align-middle ms-2">Watch Now</span>
                                        </div>
                                    </div>
                                </Col>
                            </Row>
                                    ...
                                    <Col lg={6} md={6}>
                                        <div className="position-relative me-lg-5">
                                            ...
                                            <div className="play-icon">
                                                <Link2 to="#" onClick={this.openModal} data-type="youtube" data-id="yba7hPeTSjk" className="play-btn lightbox">
                    ...
                    {/* Footer End  */}
                    {/* Back to top */}
                    <Link to="home" style={{ display: this.state.arrow === true ? 'block' : 'none' }} id="back-to-top" className="back-to-top rounded-pill fs-5"><Icon.ArrowUp className="fea icon-sm icons align-middle" /></Link>
                    {/* Back to top  */}
